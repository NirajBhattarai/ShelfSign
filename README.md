...
A supplier can still stage the real aisle before the shot — the mandatory HBAR bond covers economic honesty once shipping. Bond forfeiture blocks attestation until the supplier restakes; a clean attestation alone no longer clears the flag. Camera physics stops _remote_ faking and replay.
